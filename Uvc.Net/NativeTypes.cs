...
internal abstract class UvcHandle : SafeHandle
{
...
internal class UvcContext : UvcHandle
{
    internal UvcContext()
        : base(true)
    {
...
internal class UvcDevice : UvcHandle
{
    internal UvcDevice()
        : base(true)
    {
...
internal class UvcDeviceHandle : UvcHandle
{
...
internal class UvcStreamHandle : UvcHandle
{
...
internal enum UvcVsDescriptorSubtype
{
